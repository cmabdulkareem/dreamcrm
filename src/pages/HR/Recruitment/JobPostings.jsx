    ...
    return (
        <>
            ...
            <ComponentCard
                title="Job Postings"
                action={
                    <Link to="/hr/recruitment/jobs/new" className="flex items-center gap-2 bg-blue-950 text-white px-4 py-2 rounded-lg hover:bg-blue-900 transition-colors">
                                ...
                                {jobs.length === 0 ? (
                                    ...
                                    jobs.map((job) => (
                                        <tr key={job.id}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{job.applications?.length ?? 0}</td>
