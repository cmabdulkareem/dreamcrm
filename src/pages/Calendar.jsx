...
const Calendar = () => {
  ...
  const { events, setEvents, addEvent, updateEvent, deleteEvent } = useCalendar();
  ...
  const handleUpdateLeadStatus = () => {
    if (selectedEvent?.extendedProps?.leadId) {
      // Store the leadId in sessionStorage to open the edit modal
      sessionStorage.setItem('openLeadId', selectedEvent.extendedProps.leadId);
  ...
  return (
    <>
      <PageMeta
        title="Calendar | CDC International"
        ...
        <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] p-6 lg:p-10">
          <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
            ...
            <div className="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
              ...
              {selectedEvent && selectedEvent.extendedProps?.leadId && (
                <button
                  type="button"
                  className="flex w-full justify-center rounded-lg border border-yellow-500 bg-yellow-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-yellow-600 sm:w-auto"
