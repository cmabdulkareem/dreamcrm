...
const AppSidebar = () => {
  ...
  return (
    <aside
      className={`fixed top-16 lg:top-0 bottom-0 flex flex-col px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 transition-all duration-300 ease-in-out z-50 border-r border-gray-200 
    ...
    >
      ...
      <div className="flex flex-col flex-1 min-h-0 overflow-y-auto duration-300 ease-linear no-scrollbar pb-24">
        <nav className="mb-6">
