...
// Helper function to determine lead potential colors and styles for the status bar
export const getLeadPotentialStyles = (leadPotential) => {
  switch (leadPotential) {
    ...
    case "notAProspect":
      return { bar: "bg-gray-400" };
    default:
      return { bar: "bg-transparent" };
  }
};
