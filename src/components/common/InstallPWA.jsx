...
const InstallPWA = () => {
    ...
    const showIOSInstallPrompt = () => {
        ...
        toast.info(
            <div className="flex flex-col gap-2 p-1 text-left">
                <p className="font-bold text-gray-800 dark:text-white">Install CDC International on iOS</p>
    ...
    const showInstallPrompt = (e) => {
        ...
        toast.info(
            <div className="flex flex-col gap-2 p-1 text-left">
                <p className="font-bold text-gray-800 dark:text-white">Install CDC International App</p>
