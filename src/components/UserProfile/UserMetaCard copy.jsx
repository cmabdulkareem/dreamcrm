...
import { courseOptions, countries, accountStatus, accountGender, departments, employmentType } from "../../data/DataSets";

export default function UserMetaCard({ user }) {
  const { isOpen, openModal, closeModal } = useModal();
  const [selectedValues, setSelectedValues] = useState(user?.roles || ["General"]);
  const [dob, setDob] = useState(user?.dob ? new Date(user.dob) : null);
  const [joiningDate, setJoiningDate] = useState(user?.createdAt ? new Date(user.createdAt) : null);
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="w-full">
                    ...
                    <Input type="text" id="employeeCode" value={user?.employeeCode || ""} />
                  </div>
                  <div className="w-full">
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="w-full">
                    ...
                    <Input type="text" id="designation" value={user?.designation || ""} />
                  </div>
                  <div className="w-full">
                    <Label>Employment Type</Label>
                    <Select
                      key={user?.employmentType}
